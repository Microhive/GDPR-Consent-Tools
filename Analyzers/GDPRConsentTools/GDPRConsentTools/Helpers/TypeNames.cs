...
namespace Microsoft.AspNetCore.Mvc.Analyzers
{
    internal static class TypeNames
    {
        ...
        public const string IdentityDbContext = "Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityDbContext";

        // GDPR
        public const string PIIAttribute = "GDPR.Attributes.PIIAttribute";

        public const string PurposeAttribute = "GDPR.Attributes.PurposeAttribute";

        public const string GDPRPoliciesAttribute = "GDPR.Attributes.GDPRPoliciesAttribute";

        public const string IGDPRPolicies = "GDPR.Core.IGDPRPolicies";
    }
}
